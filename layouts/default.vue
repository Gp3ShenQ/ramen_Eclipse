<template>
  <div class="relative w-full h-screen">
    <div class="top-0 left-0 absolute flex justify-center w-full h-[1500px]" style="background-image: url('/layout/background6.png')"></div>
    <div class="top-0 left-0 fixed absolute w-full h-full video-area">
      <div class="top-0 left-0 z-30 absolute w-full h-full mask"></div>
...
const videoBoxSize = () => {
  ...
  tl.fromTo(
    ...
    { duration: 2, 'clip-path': 'inset(0% 0% 0% 0%)' }, // 最終值
  )
  ...
  tk.fromTo(
    ...
    { 'background-color': 'rgba(0,0,0, 0.5)' }, // 最終值
  )
}
