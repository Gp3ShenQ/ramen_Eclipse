<template>
  <div class="flex max-[800px]:flex-col bg-[url('/public/about/background_white.png')] pt-20 w-full">
    ...
    <div class="flex flex-col justify-center items-center max-[800px]:mt-10 px-20 max-[800px]:px-10 w-full max-w-1/3 max-[800px]:max-w-full">
      <div class="en-font-700 text-[##3A4454] text-2xl">
        <p class="">我們精心準備了</p>
        <p class="">　　能夠引出拉麵與燒肉美味的講究佳釀</p>
      </div>
      <div class="mt-5">
        <div class="en-font-700 text-[##3A4454] text-base leading-10">
          <p>提供與燒肉相得益彰的日本酒、</p>
          <p>以及完美襯托拉麵風味的頂級清酒與威士忌</p>
          <p>皆由我們嚴選挑選。請盡情享受這些能夠提升料理美味的極上美酒</p>
        </div>
      </div>
    </div>
